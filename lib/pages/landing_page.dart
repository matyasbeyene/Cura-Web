...
const _LandingCopy _studentCopy = _LandingCopy(
  ...
  introBody:
      'Cura helps students build better focus habits by '
      'encouraging them to study at productive locations '
      'around campus. Earn rewards from local businesses while '
      'discovering new places to learn, work, and grow.',
